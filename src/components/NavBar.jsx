        ...
        <div>
            ...
            <List style={{ background: '#404040', color: 'white' }}>
                ...
                <Link to={{pathname:'/SearchMovie'}} className={classes.links}>
                    <ListItem button>
                        <ListItemIcon style={{ color: 'white' }}> <Search/> </ListItemIcon>
                        <ListItemText primary='Buscar'/>   
                    </ListItem>
                </Link>
                <Link to={{pathname:'/NewMovie'}} className={classes.links}>
                    <ListItem button>
                        <ListItemIcon style={{ color: 'white' }}> <Add/> </ListItemIcon>
                        <ListItemText primary='Nueva Reseña'/>   
                    </ListItem>
                </Link>
                <Link to={{pathname:'/EditMovie'}} className={classes.links}>
                    <ListItem button>
                        <ListItemIcon style={{ color: 'white' }}> <Create/> </ListItemIcon>
