...
import { Typography, Grid, Snackbar, Paper, Divider, Button, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions } from "@material-ui/core";
            ...
            <div>
                <Paper className={classes.paper} elevation={3}>
                    <Grid container justify="center" direction="column">
                        <Grid item container justify='center'>
                            <div className={classes.image}>
                                <img className={classes.image} src="https://picsum.photos/id/237/200/300" alt="poster"/>
                            </div>
                        </Grid>
                        <Divider/>
                        <Grid item>
                    ...
                    <Grid item
                        ...
                        direction="row"
                    >
                        <Link to={{pathname:`/movies/editMovie/${id_pelicula}`, state: { movie }}} className={classes.links}>
                            <Button
                                variant="contained"
                                size="medium"
